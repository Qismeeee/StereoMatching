...
left_img_path = 'StereoMatching/Aloe/Aloe_left_1.png'
right_img_path = 'StereoMatching/Aloe/Aloe_right_1.png'
disparity_range = 64
kernel_size = 5
...
# Calculate the disparity map using cosine similarity
...
# Display the disparity map and the color map
cv2.imshow('Disparity Map', depth)
cv2.imshow('Color Disparity Map', cv2.applyColorMap(depth, cv2.COLORMAP_JET))
cv2.waitKey(0)
cv2.destroyAllWindows()
