...
left_img_path = 'StereoMatching/left.png'
right_img_path = 'StereoMatching/right.png'
disparity_range = 16
...
cv2.imshow('L1 Depth Image', depth_l1)
cv2.imshow('L1 Color Depth Image', color_l1)
cv2.waitKey(0)
...
cv2.imshow('L2 Depth Image', depth_l2)
cv2.waitKey(0)
cv2.destroyAllWindows()
